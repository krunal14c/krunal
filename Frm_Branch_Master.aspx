<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Frm_Branch_Master.aspx.cs" Inherits="Frm_User_Master" %>
    ...
    <section id="bannerSection" style="background-color: black">
        <div class="container">
            <h1 id="pageTitle">
                ...
                <asp:Label runat="server" ForeColor="GreenYellow" Font-Size="X-Large">Branch Master</asp:Label>
            </h1>
        </div>
    </section>
    <!-- Page banner end -->
                                ...
                                <div class="row">
                                    <div id="Div2" class="span4 wow fadeInRight input-field" runat="server">
                                        <div class="thumbnail" style="background-color: darkcyan">
                                            <h3 style="color: Red">Branch Master</h3>
                                            <div class="control-group">
                                                <div class="controls">
                                                    <table>
                                                        <tr></tr>
                                                        <tr>
                                                            <td style="color: White"><b>Branch ID</b></td>
                                                            <td>
                                                                <asp:TextBox ID="txtBranch_ID" Font-Bold="true" CssClass="span3" runat="server" Enabled="false"></asp:TextBox>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td style="color: White"><b>Branch Code :</b></td>
                                                            <td>
                                                                <asp:TextBox ID="txtBranchcode" Font-Bold="true" CssClass="span3" runat="server" ToolTip="Type Branch Code here..."></asp:TextBox>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td style="color: White"><b>Branch Name :</b></td>
                                                            <td>
                                                                <asp:TextBox ID="txtBranchname" Font-Bold="true" CssClass="span3" runat="server" ToolTip="Type password here..."></asp:TextBox>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td style="color: White"><b>From Date :</b></td>
                                                            <td>
                                                                 <asp:TextBox ID="txtcalfrom" CssClass="span3" runat="server" MaxLength="2" Enabled="true" ReadOnly="true" ToolTip="Click and select date here...." />
                                                                <ajaxToolkit:CalendarExtender ID="CalendarExtenderfrom" Animated="true" PopupPosition="BottomLeft" Format="dd/MM/yyyy" runat="server"
                                                                    TargetControlID="txtcalfrom" OnClientDateSelectionChanged="AppendTime">
                                                                </ajaxToolkit:CalendarExtender>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                        <tr>
                                                            <td style="color: White"><b>To Date :</b></td>
                                                            <td>
                                                                <asp:TextBox ID="txtcalto" CssClass="span3" runat="server" MaxLength="2" Enabled="true" ReadOnly="true" ToolTip="Click and select date here...." />
                                                                <ajaxToolkit:CalendarExtender ID="CalendarExtenderto" Animated="true" PopupPosition="BottomLeft" Format="dd/MM/yyyy" runat="server"
                                                                    TargetControlID="txtcalto" OnClientDateSelectionChanged="AppendTime">
                                                                </ajaxToolkit:CalendarExtender>
                                                            </td>
                                                        </tr>
                                                    </table>
                        ...
                        <div id="div3" class="col-md-1 col-sm-1" runat="server">
                            <div class="row">
                                <div id="Table" class="span5 wow fadeInRight input-field" runat="server">
                                    <div class="control-group">
                                        <div class="controls">
                                            <asp:GridView ID="gridBranch" runat="server" CellPadding="3"
                                                ...
                                                OnPageIndexChanging="gridBranch_PageIndexChanging" OnRowCommand="gridBranch_RowCommand">
                                                <Columns>
                                                    ...
                                                    <asp:BoundField DataField="branchcode" HeaderText="Branch Code" InsertVisible="False" ReadOnly="True" SortExpression="branchcode"></asp:BoundField>
                                                    <asp:BoundField DataField="branchname" HeaderText="Branch Name" InsertVisible="False" ReadOnly="True" SortExpression="branchname"></asp:BoundField>
                                                    <asp:BoundField DataField="fromdt" HeaderText="From Date" InsertVisible="False" ReadOnly="True" SortExpression="fromdt"></asp:BoundField>
                                                    <asp:BoundField DataField="todt" HeaderText="To Date" InsertVisible="False" ReadOnly="True" SortExpression="fromdt"></asp:BoundField>
