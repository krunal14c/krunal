<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Stock_Summary.aspx.cs" Inherits="Stock_Summary" %>
...
<head>
    <meta charset="utf-8">
    <title><%= Session["Comp_Name"] %> 's Stock Summary </title>
...
<body runat="server">
    ...
    <form id="frm" runat="server">
      ...
      <asp:GridView ID="gridCustomer" runat="server" CellPadding="2"
        CellSpacing="2" DataKeyNames="Value" CssClass="responsive table table-condensed" AllowPaging="false"
