<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Frm_Admin_Report.aspx.cs" Inherits="Frm_Admin_Report" %>
...
<body runat="server">
    ...
    <form id="frm" runat="server">
      <center>
       <asp:Label ID="Label1" runat="server" Font-Bold="true" Font-Names="Arial" ForeColor="Maroon" Font-Size="Medium">Petty Cash Report : <%= Session["Emp_Name"] %>,</asp:Label> &nbsp;
       <asp:Label ID="lblBalance" runat="server" Font-Bold="true" Font-Names="Arial" ForeColor="Blue" Font-Size="Medium"></asp:Label> &nbsp; 
       <asp:Label ID="lblMonth_Year" runat="server" Font-Bold="true" Font-Names="Arial" ForeColor="Red" Font-Size="Medium"><%= Session["Emp_Month_Name"] %>, <%= Session["Emp_Year_Id"]%></asp:Label>
